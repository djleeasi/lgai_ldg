...
def main():
    ...
    for fold in range(foldNum):
        ...
        train_loader_n = DataLoader(ProcessDataset(train_x_n, train_y_n, mode = False), trainparams.BATCH_SIZE, shuffle = True)
        train_loader_an = DataLoader(ProcessDataset(train_x_an, train_y_an, mode= False), trainparams.BATCH_SIZE, shuffle = True)
